...
enum class Ytelse {
    ...
    fun somBehandling(): Behandling = when (this) {
        ...
        OPPLARINGSPENGER -> Behandling.PLEIEPENGER_SYKT_BARN // TODO("Legg til riktig behandling før lansering")
        UNGDOMSYTELSE -> Behandling.PLEIEPENGER_SYKT_BARN // TODO("Legg til riktig behandling før lansering")
    }
}
